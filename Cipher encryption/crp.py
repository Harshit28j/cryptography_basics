...
#_________TO make encryption more strong you can use this hex method___________________________
#__________Uncomment the below code you will get more encrypted unplained text________
for letters in en:
